    ...
    <div class="py-3 mb-4 shadow-sm bg-dark border-top">
        <div class="container">
            <h6 class="mb-6 text-light">
                ...
                / <a href="#">{{ optional(App\Models\Category::find($product->category))->name }}</a> 
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 border-right">
                        <img src="{{ asset('./admin/productimages/' . $product->image) }}" class="w-100" alt="">
                    </div>
                    <div class="col-md-8">
                        <h2 class="mb-0">
                            {{ $product->name }}
                        ...
                        @if ($product->quantity > 0)
                            <label class="badge bg-success text-dark p-2">{{$product->current_status}}</label>
                        @else
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-10">
                                <br>
                                @if ($product->quantity > 0)
                                <button type="button" class="btn btn-primary mt-2 me-3 AddToCart float-start"><i class="fa-solid fa-cart-shopping"></i> Add to Cart</button>
                                @endif
                                <button type="button" class="btn btn-success mt-2 me-3 float-start"><i class="fa-solid fa-heart"></i> Add to Wishlist</button>
                            </div>
                        </div>
                    </div>
                </div>
