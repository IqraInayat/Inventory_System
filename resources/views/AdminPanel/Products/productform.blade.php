...
<form action="{{ route('add_product') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6 mb-3">
            ...
            <input type="number" name="original_price" class="form-control" id="original_price" placeholder="Enter original_price..." value="{{ old('original_price') }}">
            <p class="text-danger">
        ...
        <div class="col-md-6 col-sm-6 mb-3">
            ...
            <input type="number" name="selling_price" class="form-control" id="selling_price" placeholder="Enter selling_price..." value="{{ old('selling_price') }}">
            <p class="text-danger">
                @error('selling_price')
                    {{ $message }}
                @enderror
        ...
        <div class="col-md-6 col-sm-6 mb-3 form-floating">
            <textarea name="small_description" class="form-control" id="small_description" rows="3" placeholder="Enter small description">{{old('small_description')}}</textarea>
        ...
        <div class="col-md-6 col-sm-6 mb-3">
            ...
            <textarea name="meta_description" class="form-control" id="meta_description" rows="3" placeholder="Enter meta description">{{old('meta_description')}}</textarea>
            <p class="text-danger">
        ...
        <div class="col-md-6 col-sm-6 mb-3">
            ...
            <textarea name="meta_keywords" class="form-control" id="meta_keywords" rows="3" placeholder="Enter meta keywords">{{old('meta_keywords')}}</textarea>
            <p class="text-danger">
                @error('meta_keywords')
                    {{ $message }}
                @enderror
